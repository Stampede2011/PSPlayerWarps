...
public class Base implements CommandExecutor {
    ...
    public static CommandSpec build() {
        ...
        return CommandSpec.builder()
                ...
                .child(Set.build(), new String[] { "set", "create"})
                .child(Remove.build(), new String[] { "remove"})
                .child(Desc.build(), new String[] { "desc"})
                .child(Open.build(), new String[] { "open"})
                .child(Like.build(), new String[] { "like"})
                .child(List.build(), new String[] { "list"})
                .child(Icon.build(), new String[] { "icon"})
                .child(Warp.build(), new String[] { "warp"})
                .build();
    }
}
